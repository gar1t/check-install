...
#
# This script is used to check install candidates for the `pip
# install` command. To use this script, run it with a requirement
# specifier:
#
#   python check_pip_install.py guildai
#
# You can optionally provide any of the `pip install` command line
# options to the script. For a list of options, run `pip install
# --help`.
#
